...
<div>
    ...
    <form action="{{ route('medicamentos.store') }}" method="POST" class="formulario-paciente">
        @csrf
        ...
        <div class="group-control">
            ...
            <input type="text" name="frecuencia" id="frecuencia" value="{{ old('frecuencia') }}" required>
        </div>
        ...
        <div class="group-control">
            ...
            <input type="text" name="proveedor" id="proveedor" value="{{ old('proveedor') }}" required>
        </div>

        <div class="group-control">
            <label for="efectos_secundarios">Efectos Secundarios</label>
            <textarea name="efectos_secundarios" id="efectos_secundarios">{{ old('efectos_secundarios') }}</textarea>
        </div>
