...
<!-- Formulario -->
<form action="{{ route('medicos.store') }}" method="POST" class="formulario-paciente">
    @csrf
    ...
    <div class="group-control">
        ...
        <input type="number" name="años_experiencia" id="años_experiencia" value="{{ old('años_experiencia') }}" required>
